...
#of the PB distribution, corresponding to the fast runners, where this selection effect
#unlikely to apply, and then comparing the fitted normal distribution to the actual.
...
#Should just need to add an extra term to likelihood to account for this -
#although if I do that I'm not really fitting just to the tail any more.
#So probably my original approach is the best.
